...
Ext.define('Traccar.view.SettingsMenuController', {
    ...
    requires: [
        ...
        'Traccar.view.edit.PointsOfInterest',
    ...
    init: function () {
        ...
        if (admin || !readonly) {
            ...
            this.lookupReference('settingsPointsOfInterestButton').setHidden(
                Traccar.app.getVehicleFeaturesDisabled() || Traccar.app.getBooleanAttributePreference('ui.disableDrivers'));
    ...
    onPointsOfInterestClick: function () {
            Ext.create('Traccar.view.BaseWindow', {
                title: Strings.sharedPointsOfInterest,
                items: {
