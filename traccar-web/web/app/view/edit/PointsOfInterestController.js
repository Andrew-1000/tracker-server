...
Ext.define('Traccar.view.edit.PointsOfInterestController', {
    extend: 'Traccar.view.edit.ToolbarController',
    alias: 'controller.pointsofinterest',

    requires: [
        'Traccar.view.dialog.PointOfInterest',
        'Traccar.model.PointOfInterest'
    ],
